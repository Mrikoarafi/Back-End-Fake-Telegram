...
const sendingEmail = {
	...
	emailSend: email => {
                                                        ...
                                                        <div style="border-top:0px solid transparent; border-left:0px solid transparent; border-bottom:0px solid transparent; border-right:0px solid transparent; padding-top:0px; padding-bottom:0px; padding-right: 0px; padding-left: 0px;">
                                                            <div>
                                                                <div style=" margin-top:20px ; font-family:'Montserrat'">
                                                                    <p style="text-align: center; line-height: 1.2; word-break: break-word; font-size: 38px;  margin: 0;"><span style="font-size: 38px; color: #48bdbd;">Telegram Fake</span></p>
                                                                </div>
                                                            </div>
                                                            <div>
                                                                <div style="font-size: 12px; color: #393d47; font-family: 'Montserrat';">
                                                                    <p style="text-align: center; line-height: 1.2; word-break: break-word; font-size: 13px;margin: 0;"><span style="font-size: 13px; color: #808080;">Let's notify each other</span></p>
                                                                </div>
                                                            </div>
		...
		let mailOptions = {
			from: '"Telegram Fake" <no-reply@gmail.com>',
